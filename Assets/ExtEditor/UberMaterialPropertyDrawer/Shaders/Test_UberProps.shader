Shader "Test/UberProps"
{
    Properties
    {
        ...
        [Uber(NestGroup,  BeginGroup)]      _UseNestFeature ("_UseNestFeature", int) = 0
        [Uber(NestGroup)]                   _NestFeatureColor ("_NestFeatureColor", color) = (0.2,0.7,0.8)
        [Uber(GrandChild, BeginGroup)]      _BeginGroundChild ("_BeginGroundChild", int) = 0
        [Uber(GrandChild)]                  _GrandChildVector ("_GrandChildVector", vector) = (0,0,0,0)
